# -*- encoding: utf-8 -*-
# stub: meta-tags 2.22.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.25.0"])
    ...
    s.add_dependency(%q<actionpack>.freeze, [">= 6.0.0", "< 8.1"])
    s.add_dependency(%q<appraisal>.freeze, ["~> 2.5.0"])
    s.add_dependency(%q<railties>.freeze, [">= 3.2.0", "< 8.1"])
